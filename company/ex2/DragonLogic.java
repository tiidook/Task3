...
public class DragonLogic {
    ...
    public static int countHeads(int age){
        ...
        if (age>THIRD_PERIOD){
            ...
            count+=(age - THIRD_PERIOD) * After_300 + SECOND_PERIOD * BEFORE_300 + FIRST_PERIOD * BEFORE_200 + BORNING_COUNT;

        }else if (age>FIRST_PERIOD && age<=THIRD_PERIOD){

            count+=(age - FIRST_PERIOD) * BEFORE_300 + FIRST_PERIOD * BEFORE_200 + BORNING_COUNT;

        }else if (age>0 && age <= FIRST_PERIOD ) {
